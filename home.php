	<md-content id="site" ng-style="styles.site">
		...
		<md-list-item class="secondary-button-padding" ng-href="collection">
		...
		<md-card id="nothing" style="display:none">
			<div class="BOXnothing">
				<span>Wow. You entered nothing, searched for it and waited even {{l.time.waitingtimeinseconds}} seconds
					...
					<br><br><br>
					<small id="muhahaha">Of course I could have checked if you entered nothing, <i>before</i> the whole
						script started and loaded through. Of course I could have <i>notified</i> you that the input box
						is empty.<br>By the way, have you heard my "Muhahaha" already?</small></span>
			</div>
		</md-card>
